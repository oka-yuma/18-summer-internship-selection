            ...
            <div class="panel panel-default">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        ?>
                        <th class="sorting" data-sort-key="id" data-sort-order="{{$sort_key !== 'id'?'both':$sort_order}}" scope="col">#</th>
                        <th scope="col">姓</th>
                        <th scope="col">名</th>
                        <th class="sorting" data-sort-key="family_name_kana" data-sort-order="{{$sort_key !== 'family_name_kana'?'both':$sort_order}}" scope="col">せい</th>
                        <th class="sorting" data-sort-key="given_name_kana" data-sort-order="{{$sort_key !== 'given_name_kana'?'both':$sort_order}}" scope="col">めい</th>
                        <th scope="col">部</th>
                        <th class="sorting" data-sort-key="division_id" data-sort-order="{{$sort_key !== 'division_id'?'both':$sort_order}}" scope="col">課</th>
                        <th class="sorting" data-sort-key="position_id" data-sort-order="{{$sort_key !== 'position_id'?'both':$sort_order}}" scope="col">役職</th>
                        <th class="sorting" data-sort-key="birthday" data-sort-order="{{$sort_key !== 'birthday'?'both':$sort_order}}" scope="col">誕生日</th>
                        <th scope="col">年齢</th>
                        <th scope="col">入社日</th>
                    </tr>
                    </thead>
